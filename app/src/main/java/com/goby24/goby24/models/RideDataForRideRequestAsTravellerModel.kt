...
class RideDataForRideRequestAsTravellerModel {
    var id:Int = 0
    var date:String = ""
    var fare:String = ""
    ...
    var time:String = ""
    var traveller:TravellerForRideRequestAsTravellerModel = TravellerForRideRequestAsTravellerModel()
    var rider:RiderForRideRequestAsTravellerModel = RiderForRideRequestAsTravellerModel()
    var country:String=""
