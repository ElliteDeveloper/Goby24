...
class FragRideDetailForTouristPackageRequestAsTraveller : Fragment() {
    ...
    companion object {
        lateinit var mData: RideDataForTouristPackageRequestAsTravellerModel
        fun newInstance(): FragRideDetailForTouristPackageRequestAsTraveller {
            return FragRideDetailForTouristPackageRequestAsTraveller()
        }

        fun newInstance(
            rideData: RideDataForTouristPackageRequestAsTravellerModel
        ): FragRideDetailForTouristPackageRequestAsTraveller {
            mData = rideData
            return FragRideDetailForTouristPackageRequestAsTraveller()
        }
    }
