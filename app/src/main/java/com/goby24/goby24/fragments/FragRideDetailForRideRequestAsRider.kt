...
class FragRideDetailForRideRequestAsRider : Fragment() {
    ...
    companion object {
        lateinit var mData: RideDataForRideRequestAsRiderModel
        var mFlagIsRider: Boolean = false
        fun newInstance(): FragRideDetailForRideRequestAsRider {
            return FragRideDetailForRideRequestAsRider()
        }

        fun newInstance(
            rideData: RideDataForRideRequestAsRiderModel
        ): FragRideDetailForRideRequestAsRider {
            mData = rideData
            return FragRideDetailForRideRequestAsRider()
        }
    }
